...
${c.b_scenes_status(id="status_%s_scenes" % c.project.id,
                    ...
                    update_listener_adder="notify.add_listener_tab").display(value=c.project.scenes) | n}
<br/>
<br/>
...
${c.b_libgroups_status(id="status_%s_library" % c.project.id,
                    ...
                    update_listener_adder="notify.add_listener_tab").display(value=c.project.libgroups) | n}
<br/>
<br/>
